...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Manhwaclan = exports.ManhwaclanInfo = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const ManhwaclanMain_1 = require("./ManhwaclanMain");
const Manhwaclan_DOMAIN = 'https://manhwaclan.com';
exports.ManhwaclanInfo = {
    version: ManhwaclanMain_1.getExportVersion('0.0.0'),
    name: 'Manhwaclan',
    description: 'Extension that pulls manga from Manhwaclan',
    author: 'heznetcom',
    authorWebsite: 'https://github.com/heznetcom',
    icon: 'icon.png',
    contentRating: paperback_extensions_common_1.ContentRating.MATURE,
    websiteBaseURL: Manhwaclan_DOMAIN,
    sourceTags: [
        {
            text: 'Notifications',
...
class Manhwaclan extends ManhwaclanMain_1.ManhwaclanMain {
    constructor() {
        //FOR ALL THE SELECTIONS, PLEASE CHECK THE MangaSteam.ts FILE!!!
        super(...arguments);
        this.baseUrl = Manhwaclan_DOMAIN;
...
exports.Manhwaclan = Manhwaclan;

},{"./ManhwaclanMain":59,"paperback-extensions-common":14}],59:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ManhwaclanMain = exports.getExportVersion = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const ManhwaclanMainParser_1 = require("./ManhwaclanMainParser");
...
class ManhwaclanMain extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        /**
         ...
         * Eg. https://Manhwaclan.com/komik/one-piece/ the pathname would be "komik"
         * Default = "komik"
         */
        this.sourceTraversalPathName = 'manga';
        /**
         * The pathname between the domain and the chapter.
         * Eg. https://Manhwaclan.com/chapter/one-piece-chapter-1046-5-bahasa-indonesia/ the pathname would be "chapter"
         * Default = "chapter"
         */
        ...
        */
        this.manga_selector_AlternativeTitles = 'Alternative';
        /**
        ...
        */
        this.manga_selector_author = 'Author(s)';
        /**
        ...
        */
        this.manga_selector_artist = 'Artist(s)';
        this.manga_selector_status = 'Status';
        this.manga_tag_selector_box = 'div.genres-content';
        this.manga_tag_TraversalPathName = 'manga-genre';
        /**
        ...
        */
        this.chapter_selector_box = 'div.listing-chapters_wrap';
        /**
        ...
        */
         ...
         * Default = "ul.genre"
        */
        this.tags_selector_box = 'ul.list-unstyled';
        /**
        ...
        */
        this.homescreen_PopularToday_enabled = true;
        this.homescreen_PopularToday_selector = 'h5:contains(TRENDING)';
        this.homescreen_LatestUpdate_enabled = true;
        this.homescreen_LatestUpdate_selector_box = `h1:contains(LATEST MANGA UPDATES)`;
        this.homescreen_LatestUpdate_selector_item = 'div.page-item-detail';
        this.homescreen_NewManga_enabled = true;
        this.homescreen_NewManga_selector = 'div.page-content-listing';
        this.homescreen_TopAllTime_enabled = false;
        ...
        this.parser = new ManhwaclanMainParser_1.ManhwaclanMainParser();
    }
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            const sectionRequests = [
                ...
                {
                    request: createRequestObject({
                        url: `${this.baseUrl}/${this.sourceTraversalPathName}/?m_orderby=new-manga`,
                        method: 'GET'
                    }),
                    section: createHomeSection({
                        id: 'new_titles',
                ...
                {
                    request: createRequestObject({
                        url: `${this.baseUrl}/${this.sourceTraversalPathName}/?m_orderby=trending`,
                        method: 'GET'
                    }),
                    section: createHomeSection({
                        id: 'popular_trending',
                ...
                promises.push(this.requestManager.schedule(sectionRequest.request, 1).then(response => {
                    ...
                    switch (sectionRequest.section.id) {
                        ...
                        case 'popular_trending':
                            sectionRequest.section.items = this.parser.parseTrendingSections($, this);
                            break;
                        default:
                    }
                    sectionCallback(sectionRequest.section);
...
exports.ManhwaclanMain = ManhwaclanMain;

},{"../MadaraHelper":57,"./ManhwaclanMainParser":60,"paperback-extensions-common":14}],60:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ManhwaclanMainParser = void 0;
/* eslint-disable linebreak-style */
const paperback_extensions_common_1 = require("paperback-extensions-common");
const entities = require("entities");
class ManhwaclanMainParser {
    constructor() {
        this.parsePopularSections = ($, source) => {
            var _a, _b;
            const PopularUpdate = [];
            for (const manga of $('div.popular-item-wrap', $(source.homescreen_PopularToday_selector).parent().next()).toArray()) {
                const id = this.idCleaner((_a = $('a', manga).attr('href')) !== null && _a !== void 0 ? _a : '', source);
                const title = $('h5', manga).text().trim();
                const image = (_b = this.getImageSrc($('img', manga))) === null || _b === void 0 ? void 0 : _b.replace('-75x106', '');
                const subtitle = $('span.chapter', $('div.chapter-item', manga).first()).text().trim();
                if (!id || !title)
                    continue;
                PopularUpdate.push(createMangaTile({
                    id: id,
        ...
        this.parseTrendingSections = ($, source) => {
            ...
            for (const manga of $('div.page-item-detail').toArray()) {
                ...
                if (!id || !title)
                    continue;
                PopularTrending.push(createMangaTile({
                    id: id,
                    image: image ? image : source.fallbackImage,
                    title: createIconText({ text: this.decodeHTMLEntity(title) }),
                    subtitleText: createIconText({ text: subtitle }),
    ...
    parseMangaDetails($, mangaId, source) {
        ...
        const image = (_a = this.getImageSrc($('div.summary_image img'))) === null || _a === void 0 ? void 0 : _a.replace('-193x278', '');
        const desc = this.decodeHTMLEntity($('div.summary__content').text().trim());
        const arrayTags = [];
        for (const tag of $('a', source.manga_tag_selector_box).toArray()) {
            const label = $(tag).text().trim();
            const id = encodeURI((_c = (_b = $(tag).attr('href')) === null || _b === void 0 ? void 0 : _b.replace(`${source.baseUrl}/${source.manga_tag_TraversalPathName}/`, '').replace(/\//g, '')) !== null && _c !== void 0 ? _c : '');
            if (!id || !label)
                continue;
            arrayTags.push({ id: id, label: label });
        }
        const tagSections = [createTagSection({ id: '0', label: 'manga-genre', tags: arrayTags.map(x => createTag(x)) })];
        const rawStatus = $(`div:contains(${source.manga_selector_status}), .post-content_item:contains(${source.manga_selector_status})`).contents().remove().last().text().trim();
...
exports.ManhwaclanMainParser = ManhwaclanMainParser;
